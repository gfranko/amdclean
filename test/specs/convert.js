	...
	describe('define() method conversions', function() {
		...
		describe('functions', function() {
			...
			it('should passing a file path instead of the code directly', function() {
				var cleanedCode = amdclean.clean({ filePath: __dirname + '/../filePathTest.js', escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var example;example=undefined;";
			...
			it('should not convert defines with an /*amdclean*/ comment before it', function() {
				var AMDcode = "/*amdclean*/define('./modules/example', ['example1', 'example2'], function(one, two) {});",
					cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { comment: false, format: { compact: true } }, wrap: { start: '', end: '' } }),
			...
			it('should not convert defines with a custom commentCleanName comment before it', function() {
				var AMDcode = "/*donotremove*/define('./modules/example', ['example1', 'example2'], function(one, two) {});",
					cleanedCode = amdclean.clean({ code: AMDcode, commentCleanName: 'donotremove', escodegen: { comment: false, format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "define('./modules/example',['example1','example2'],function(one,two){});";
			...
			it('should not convert defines that are added to the ignoreModules options array', function() {
				var AMDcode = "define('exampleModule', ['example1', 'example2'], function(one, two) {});",
					cleanedCode = amdclean.clean({ code: AMDcode, ignoreModules: ['exampleModule'], escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
			...
			it('should remove defines that are added to the removeModules options array', function() {
				var AMDcode = "define('exampleModule', ['example1', 'example2'], function(one, two) {});define('exampleModule2', function() {})",
					cleanedCode = amdclean.clean({ code: AMDcode, removeModules: ['exampleModule'], escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
			...
			it('should support the plain simplified CJS wrapper', function() {
				var AMDcode = "define('example',['require','exports','module','bar'],function(require, exports){exports.bar = require('bar');});",
					cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var example;example=function (require,exports,module,bar){exports.bar=bar;return exports;}({},{},{},bar);";
			...
			it('should support global modules', function() {
				var AMDcode = "define('example', ['require', 'exports', './bar'], function(require, exports){exports.bar = require('./bar');});",
					cleanedCode = amdclean.clean({ globalModules: ['example'],  code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var example;example=function (require,exports,bar){exports.bar=bar;return exports;}({},{},bar);window.example=example;";
			...
			it('should support setting the module return value via the shimOverrides option', function() {
				var AMDcode = "define('backbone', ['underscore', 'jquery'], (function (global) { return function () { var ret, fn; return ret || global.Backbone; }; }(this)));",
					cleanedCode = amdclean.clean({ shimOverrides: { 'backbone': 'window.Backbone' }, code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var backbone;backbone=window.Backbone;";
			...
			it('should support converting define() methods with identifiers', function() {
				var AMDcode = "define('esprima', ['exports'], factory);",
					cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var esprima;esprima=function (module){return factory();}({});";
			...
			describe('optimized defines', function() {
				...
				it('should not optimize define() methods that have one or more dependencies', function() {
					var AMDcode = "define('optimized8', ['exampleDependency'], function () { return function ( thing ) { var anotherThing = true; return !isNaN( parseFloat( thing ) ) && isFinite( thing );};});",
						cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
						standardJavaScript = "var optimized8;optimized8=function (exampleDependency){return function(thing){var anotherThing=true;return!isNaN(parseFloat(thing))&&isFinite(thing);};}(exampleDependency);";
				...
				it('should not optimize basic define() methods that return a literal value that have one or more dependencies', function() {
					var AMDcode = "define('optimized11', ['someDependency'], function() { return 'Convert AMD code to standard JavaScript';});",
						cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
						standardJavaScript = "var optimized11;optimized11=function (someDependency){return'Convert AMD code to standard JavaScript';}(someDependency);";
				...
				it('should convert CommonJS require() calls and use the character prefix', function() {
					var AMDcode = "var example = require('bb_customs');",
						cleanedCode = amdclean.clean({ prefixMode: 'camelCase', code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
	...
	describe('require() method conversions', function() {
		...
		describe('functions', function() {
			...
			it('should remove all require() calls when the removeAllRequires option is set to true', function() {
				var AMDcode = "require(['testModule'], function() {var test=true;});",
					cleanedCode = amdclean.clean({ code: AMDcode, removeAllRequires: true, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "";
			...
			it('should correctly convert libraries with simple conditional AMD checks', function() {
				var AMDcode = "(function (root, factory) {" +
					...
					"}));",
					cleanedCode = amdclean.clean({ code: AMDcode, escodegen: { format: { compact: true } }, wrap: { start: '', end: '' } }),
					standardJavaScript = "var esprima;(function(root,factory){'use strict';if(true){esprima=function (module){return factory();}({});}else if(typeof exports!=='undefined'){factory(exports);}else{factory(root.esprima={});}}(this,function(exports){exports=exports||{};var test=true;return exports;}));";
