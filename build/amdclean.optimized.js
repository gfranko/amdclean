...
define('convertToIIFEDeclaration',[
  'utils',
  'defaultValues'
], function(
  utils,
...
define('convertToFunctionExpression',[
  'utils',
  'convertToIIFE',
...
define('convertToObjectDeclaration',[
  'defaultValues'
], function(
  defaultValues
) {
...
define('convertDefinesAndRequires',[
  'utils',
...
define('getNormalizedModuleName',[
  'utils',
  'normalizeModuleName'
], function(
  utils,
...
define('findAndStoreAllModuleIds',[
  'errorMsgs',
...
require([
  ...
  (function(root, factory, undefined) {
    ...
    if (typeof define === 'function' && define.amd) {
      factory.amd = true;
      define('amdclean',['esprima', 'estraverse', 'escodegen', 'underscore', 'sourcemap-to-ast'], function(esprima, estraverse, escodegen, underscore, sourcemapToAst) {
        return factory({
          'esprima': esprima,
